...
STUDENT_EXPERIMENT_REGISTRY_FILE = os.path.join(UPLOAD_DIR, "student_experiment_registry.json")
SUBMISSION_PDF_REGISTRY_FILE = os.path.join(UPLOAD_DIR, "submission_pdf_registry.json")
